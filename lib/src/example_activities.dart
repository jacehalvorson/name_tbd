...
List<ActivityType> exampleActivities = [
  ...
  videoGamesExampleActivity,
  basketballExampleActivity,
  workoutExampleActivity,
  runningExampleActivity,
  soccerExampleActivity,
  tennisExampleActivity,
  footballExampleActivity,
  baseballExampleActivity,
  swimmingExampleActivity,
  surfingExampleActivity,
  bikingExampleActivity,
  hikingExampleActivity,
  skateboardingExampleActivity,
  yogaExampleActivity,
  dancingExampleActivity,
  climbingExampleActivity,
  kayakingExampleActivity,
  bowlingExampleActivity,
  volleyballExampleActivity,
  pingPongExampleActivity,
  boxingExampleActivity,
  martialArtsExampleActivity,
  skiingExampleActivity,
  iceSkatingExampleActivity,
  weightLiftingExampleActivity,
  fishingExampleActivity,
];
